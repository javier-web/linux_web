...
<html lang="es">
    ...
    <body>
        ...
        if ($errores == false) {
            ...
            try {
               $st = $db->prepare($sql);
               $st->execute(array($nombre, $apellidos, $email, $web));
        ...
        <div class="container" style="width: 58%; height: 500px">
            ...
            <form class="form" id="myForm"  method = "post" enctype="multipart/form-data" style=" width: 300px">
                ...
                <div class="form-group">
                    ...
                    <label for = "nombre">Nombre* :</label><span><?php echo $errorNombre ?></span>
                ...
                <div class = "form-group">
                    <br><label for = "email">Email corporativo* :</label><span><?php echo $errorEmail ?></span>
