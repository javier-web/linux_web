...
<html lang="es">
    ...
    <body>
        ...
        $db = new PDO('mysql:host=localhost;dbname=trabajo;charset=utf8', 'root', '123456');
        ...
        echo '<br>';
                ...
                if (empty($_POST['email'])) {
                    ...
                    <div class="content">
                        <br><br><br>
                            ...
                            <h3 class="marquee" style="background-color: red; color: white">Por favor, escriba su dirección de correo electrónico corporativo</h3></marquee>
                                <div id="botonera">   
                                    <a href="formulario_contacto.html" class="nounderline">
                                        <input class="buttons" type="submit" value="Volver al formulario" title="Añadir nuevos contactos">
                                    </a>
                                </div>
                        <br><br>
                    </div>
            ...
            $sql = "INSERT INTO empresa (nombre, apellidos, cargo, empresa, direccion, telefono, email, asunto, texto)
                VALUES  (? , ? , ? , ? , ? , ? , ? , ? , ?)";
        ...
        <div class="content">
            ...
            <div class="botonera">   
                ...
                <a href="datatable_alumno.php" class="nounderline">
